...
initialization
  ...
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrReadPK,    TVisDeployMgrReadPK ) ;

  // Read all by group
  // gVisMgr.RegisterVisitor( cgsDeployMgrReadApp,   TVisDeployMgrFilesReadByAppName ) ;

  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrReadAppDetails, TVisDeployMgrReadOID ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrReadAppDetails, TVisDeployMgrParamsRead ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrReadAppDetails, TVisDeployMgrFilesReadByOID ) ;

  // Download a file which is out of date
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrReadBin, TVisDeployMgrReadBin ) ;
//  gVisMgr.RegisterVisitor( cgsDeployMgrLaunch,   TDeployMgrLaunch ) ;

  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrParamsDelete ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrFileDelete ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrAppDelete ) ;

  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrAppCreate ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrFileCreate ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrParamsCreate ) ;

  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrAppUpdate ) ;
  gTIOPFManager.VisMgr.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrParamsUpdate ) ;
