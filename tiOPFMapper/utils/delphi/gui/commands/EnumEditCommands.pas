unit EnumEditCommands;

interface

uses
  SysUtils, Classes, mapper, mvc_base, tiObject, EnumEditViewFrm, EnumEditController,
  AppCommands;
...
uses
  ParamEditViewFrm, EnumValueEditViewFrm, EnumValueEditController, vcl_controllers,
  AppConsts, Dialogs, Controls;
