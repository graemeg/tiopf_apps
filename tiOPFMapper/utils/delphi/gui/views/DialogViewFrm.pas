...
uses
  ...
  Dialogs, BaseDialogViewFrm, StdCtrls, ComCtrls, Spin;
...
class function TDialogView.GetDate(var ADataTime: TDateTime; const AMsg: string): Boolean;
var
  lFrm: TDialogView;
begin
...
class function TDialogView.GetDateTime(var ADataTime: TDateTime; const AMsg: string): Boolean;
begin

end;

class function TDialogView.GetDouble(var ADoubleValue: Double; const AMsg: string): Boolean;
var
  lFrm: TDialogView;
begin
  lFrm := TDialogView.Create(nil);
...
class function TDialogView.GetInteger(var AIntValue: Int64; const AMsg: string): Boolean;
var
  lFrm: TDialogView;
begin
  lFrm := TDialogView.Create(nil);
...
class function TDialogView.GetString(var AStringValue: string; const AMsg: string): Boolean;
var
  lFrm: TDialogView;
begin
  lFrm := TDialogView.Create(nil);
...
class function TDialogView.GetTime(var ADataTime: TDateTime; const AMsg: string): Boolean;
begin
